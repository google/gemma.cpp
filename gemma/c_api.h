...
GEMMA_API int GemmaCreateConversation(GemmaContext* ctx, const char* conversation_name); // Renamed
GEMMA_API int GemmaSwitchConversation(GemmaContext* ctx, const char* conversation_name); // Renamed
GEMMA_API int GemmaDeleteConversation(GemmaContext* ctx, const char* conversation_name); // Renamed
GEMMA_API int GemmaHasConversation(GemmaContext* ctx, const char* conversation_name); // Renamed
